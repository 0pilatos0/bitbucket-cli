...
| `read:repository:bitbucket` | `bb repo list`, `bb repo view`, `bb commit list/view`, `bb status list`, `bb search code` |
...
- Destructive commands (`bb repo delete`, `bb repo default-reviewers remove`, `bb pr comments delete`, `bb snippet delete`, `bb snippet comments delete`) ask `Continue? (y/N)` when `-y/--yes` is missing.
