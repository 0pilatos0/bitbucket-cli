...
| `read:repository:bitbucket` | `bb repo list`, `bb repo view`, `bb repo ls/cat`, `bb repo downloads list`, `bb commit list/view`, `bb status list` |
...
That gate applies to `bb repo delete`, `bb repo default-reviewers remove`, `bb repo downloads delete`, `bb pr comments delete`, `bb snippet delete`, and `bb snippet comments delete`.
