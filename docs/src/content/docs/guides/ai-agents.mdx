...
<Tabs>
  <TabItem label="Claude Code">
    ...
    **Repos:** `bb repo list`, `bb repo clone workspace/repo`, `bb repo view`; read files without cloning: `bb repo ls [path]`, `bb repo cat <path> --ref <ref>`
...
| `read:repository:bitbucket` | `bb repo list`, `bb repo view`, `bb repo ls/cat`, `bb commit list/view`, `bb status list` — browse repos and commits |
