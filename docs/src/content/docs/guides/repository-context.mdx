...
| Repository-scoped | `bb pr *`, `bb pipeline *`, `bb commit *`, `bb status *`, `bb browse`, `bb repo view`, `bb repo delete`, `bb repo default-reviewers *`, `bb webhook *` | `6001 CONTEXT_REPO_NOT_FOUND` |
