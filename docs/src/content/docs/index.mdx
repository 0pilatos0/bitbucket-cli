...
## Pick a Workflow <Badge text="New" variant="tip" />
...
<CardGrid>
  <LinkCard
    ...
    description="Open pull requests quickly, then edit titles and descriptions without context switching."
  />
  <LinkCard
    title="Review and merge safely"
    href="/commands/pr/review-and-merge/"
    description="Approve, decline, mark draft PRs ready, and merge with explicit strategy controls."
  />
  <LinkCard
    title="Inspect diffs and checkout"
    href="/commands/pr/diff-and-checkout/"
    description="View patches, open browser diffs, or checkout PR branches locally for deep review."
  />
  <LinkCard
    title="Automate comments and reviewers"
    href="/commands/pr/comments/"
    description="Use script-friendly commands for review comments and reviewer management."
  />
</CardGrid>

<LinkButton href="/commands/pr/" icon="right-arrow" variant="primary">Browse PR command workflows</LinkButton>
...
## Feature Highlights <Badge text="Updated" variant="note" />
