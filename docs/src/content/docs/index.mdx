...
template: splash
hero:
  title: "Fast, scriptable, and honest about its output. <span class='mono'>bb</span> puts Bitbucket Cloud in your terminal."
  tagline: "Fifteen command groups over the full 2.0 REST API. Every command outputs JSON — <code>--json</code> projects exactly the fields you name, <code>--jq</code> filters in-process."
  actions:
    - text: Quick start
