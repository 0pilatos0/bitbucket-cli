...
**values** | [**Array&lt;PipelineRunner&gt;**](PipelineRunner.md) | The values of the current page. | [optional] [default to undefined]
...
```typescript
import { PaginatedPipelineRunners } from './api';

const instance: PaginatedPipelineRunners = {
    page,
    values,
    size,
    pagelen,
