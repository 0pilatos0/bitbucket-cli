 ...
 *
 * NOTE: `src/cli.ts`, the command groups' `register.ts` modules, and
 * `src/services/oauth.service.ts` still hardcode this origin (help-text
 * `seeAlso` blocks and OAuth copy). Adopting this constant there is a
 * mechanical follow-up, deliberately left out of the change that introduced
 * it to keep the diff reviewable.
 */
